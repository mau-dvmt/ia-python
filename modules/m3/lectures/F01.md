...
<iframe src="//www.slideshare.net/slideshow/embed_code/key/6V0o12YQOxGJBN" width="595" height="485" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%;" allowfullscreen> </iframe> <div style="margin-bottom:5px"> <strong> <a href="//www.slideshare.net/AntonTibblin/ht18-da354a-if-for-while" title="HT18 - DA354A - If, for, while" target="_blank">HT18 - DA354A - If, for, while</a> </strong> from <strong><a href="https://www.slideshare.net/AntonTibblin" target="_blank">Anton Tibblin</a></strong> </div>
...
text = input("Ange det du vill översätta till rövarspråket: ")
# Translates and prints the text to "rövarspråk"
text_as_rovar_sprak = rovar_sprak(text)
# Prints the new text
print(text_as_rovar_sprak)
{% endhighlight %}
