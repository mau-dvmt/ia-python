...
Vid nedladdning bör du i dagsläget välja Python 2.7.X framför Python 3.X, då version 3 introducerat en mängd bakåtinkompatibla ändringar. Python 2.X är därför under fortsatt utveckling, parallellt med 3.X.


Den officiella utvecklingsmiljön för Python heter IDLE och följer med installationspaketet. IDLE är också installerat på datorterminalerna vid TS. Öppna IDLE nu. Du bör mötas av ett exekveringsfönster likt:
