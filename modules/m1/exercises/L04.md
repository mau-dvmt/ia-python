...
2. Utgå från koden ovan, men modifiera den enligt:
	- Skapa variabeln "location" och använd funktionen *raw_input* för att hämta in svaret från användaren
	- Skapa variabeln "age" och använd funktionen *raw_input* för att hämta in svaret från användaren
	- Uppdatera "print"-raden så att den även skriver ut besökarens hemstad och ålder (så att det ser ut som på bilden ovan)
