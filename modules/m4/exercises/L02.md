...
1. Visa filmer
    - Sortera filmer kronologiskt (**bonus**, lite svårare,  men googla gärna och fundera på om man kan använda listor till detta)
    - Sortera filmer efter bäst betyg (**bonus**, lite svårare,  men googla gärna och fundera på om man kan använda listor till detta)
	- Sortera filmer efter sämst betyg (**bonus**, lite svårare,  men googla gärna och fundera på om man kan använda listor till detta)
	- Sordera filmer i alfabetisk ordning (**bonus**, lite svårare,  men googla gärna och fundera på om man kan använda listor till detta)
