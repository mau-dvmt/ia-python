...
- Bingo
    ...
    - Dragning: Ni slumpar fram 10st tal mellan 1 och 25 som ni sedan presenterar för användaren i en utskrift (se exempelkörning nedan)
    - Resultat: Resultatet av dragningen (antal rätt) presenterast för användaren
- Statistik
...
- Er spelplan (som används vid presentation av dragningen) ska representeras av en nestlad lista (storlek: 5 * 5).
