...
Vi ska i denna uppgift bygga en resultathanterare för en minigolftävling. Minigolftävlingen går ut på att varje person spelar tre varv (rundor) och det totala antalet slag avgör vem som vinner. Vi ska spara resultatet i en textfil som har följande struktur:
...
En exempelfil att utgå från (med några förinlagda resultat) finns att hämta [här](result.txt).
...
- Filens innehåll ska följa angiven struktur (som beskrivs i uppgiftsbeskrivningen).
