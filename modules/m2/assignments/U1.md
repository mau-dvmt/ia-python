...
- Koden ska vara tydlig och lättläst med avseende på namngivning, strukturering och kommentarer. Funktionerna ska ha en beskrivning vad de gör, genom _docstrings_ (`''' Kommentar för funktionen '''`-kommentarer).
...
Programmets källkod ska laddas upp på It's Learning. Första deadline är senast xxx. Sena inlämningar kan göras (och rättas) i samband med kommande uppgifter.